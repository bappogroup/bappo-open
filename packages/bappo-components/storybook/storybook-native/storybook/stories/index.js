...
require('./1-primitives/Image/ImageScreen');
require('./1-primitives/Pdf/PdfScreen');
...
require('./2-components/IconCard/IconCardScreen');
require('./2-components/IconSelector/IconSelectorScreen');
