...
import { url } from '../../../url';
import FormAndList from './examples/FormAndList';
  ...
  <KeyboardAwareScrollView>
    <UIExplorer title="Form" url="1-primitives/Form">
        ...
        <DocItem
          ...
          description={
            <AppText>
              ...
              <Code>onValueChange</Code> and <Code>value</Code>. It must also
              have instance methods <Code>blur()</Code> and <Code>focus()</Code>
              .
            </AppText>
          }
        />
      ...
      <Section title="Examples">
        ...
        <DocItem
          description="Form In a ScrollView"
          example={{
            render: () => <FormAndList />,
          }}
        />
